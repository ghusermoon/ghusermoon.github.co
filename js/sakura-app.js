...
function code_highlight_style () {
	function gen_top_bar (i) {
		...
		$('pre:eq(' + i + ')').addClass('highlight-wrap-new')
...
function copy_code_block () {
	$('pre code').each(function (i, block) {
		...
		$(this).before('<a class="copy-code" href="javascript:" data-clipboard-target="#hljs-' + i + '"><span>copy</span></a>')
	})
...
function reload_show_date_time () {
	BirthDay = new Date('06/02/2019 18:00:00')
	today = new Date()
...
var home = location.href,
	...
	Siren = {
		TOC: function () {
			if ($('.toc').length > 0 && document.body.clientWidth > 1200 && false) {
